...
class Economy(commands.Cog):
    ...
    @app_commands.describe(server_id="The server ID to check balance for")
    ...
    @app_commands.describe(server_id="The server ID to claim daily reward for")
    @app_commands.autocomplete(server_id=server_id_autocomplete)
    ...
    @app_commands.describe(server_id="The server ID to check leaderboard for")
    @app_commands.autocomplete(server_id=server_id_autocomplete)
    ...
    @app_commands.describe(
        server_id="The server ID to play on",
